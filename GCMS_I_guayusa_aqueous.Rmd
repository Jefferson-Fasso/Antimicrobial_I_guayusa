...
A continuaci[on los contaminantes de acuerdo con el blanco de procesamiento sr[an removidos.
...
El siguente paso remuevo los QC, ya que, no ser[a necesaro en an[alisis posteriores.
...
A contimuación se visualiza los datos sin los QC.
...
El siguiente paso crea clusters. Este paso reduce el n[umero de picos cromatogr[aficos ya que correlaciona posibles gragmentos debido a la ionizaci[onde 70 eV mediante impacto de electrones (EI).
...
Podemos inspecionar los datos tras la b[usqueda de clusters.
...
En el siguiente paso se imputar[a los datos faltantes.
...
# Save plot
ggsave('Result/GCMS/GCMS_Loadings.png', width = 20, height = 15, device='png', dpi="print")
...
# Group legend
lgd2 <- Legend(labels = gt_render(c("4-6 años luz",
                                    "4-6 años sombra",
                                    "8-10 años luz",
                                    "8-10 años sombra")),

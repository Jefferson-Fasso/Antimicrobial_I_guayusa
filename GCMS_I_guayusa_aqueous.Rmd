...
data <- read_from_excel(file = "Data/Guayusa_H2O_GCMS_to_R.xlsx", sheet = 1, 
...
# PCA plot
ggplot(scores,
       aes(PC1, PC2, shape = Test, color = Test)) +
  geom_point(size = 3) +
  guides(x=guide_axis(title = "PC1 (46.82 %)"),
         y=guide_axis(title = "PC2 (11.10 %)")) +

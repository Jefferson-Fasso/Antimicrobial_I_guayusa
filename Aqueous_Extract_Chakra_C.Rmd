---
title: "Actividad antimicrobiana de extracto acuoso de hojas de *I. guayusa*"
...
El presente trabajo tiene el objetivo de evaluar la actividad antimicrobiana de extractos acuosos de hojas de *I. guayusa* a dos edades (especímenes de 4-6 años y 8-10 años) y dos exposiciones de luz por cada edad (entorno de 65-190 lux y 200-425 lux).
...
Como el p-value es 0.1386, y éste es un valor superior de 0.05, aceptamos la hipótesis nula (H0). Esto nos indica que las muestras presentan varianzas semejantes.
...
Como el p-value es 0.06269, y éste es un valor superior de 0.05, aceptamos la hipótesis nula (H0). Esto nos indica que las muestras presentan varianzas semejantes.
...
Como el p-value es 0.07718, y éste es un valor superior de 0.05, aceptamos la hipótesis nula (H0). Esto nos indica que las muestras presentan varianzas semejantes.
